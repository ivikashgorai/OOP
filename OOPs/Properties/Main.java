...
public class Main {
    public static void main(String[] args) {
        Box b1 = new Box();
        System.out.println(b1.weight);// this will give an erroe because child class variable are not accessed by
                                      // parent class
        ...
        System.out.println(b2.weight);// this will give an er because it type of refrence varibale not object which
                                      // determines what member can be accessed
